# Install Mach on macOS

Mach is a native Mac app for dictation and live translation. This guide takes you
from download to your first dictation.
...
Microphone access lets Mach capture audio when you start a dictation. Enable
Mach under **Privacy & Security → Microphone**.
...
1. Place the cursor in a text field in any Mac app.
2. Press and hold `Fn`.
3. Speak naturally.
...
If Mach cannot hear you, verify Microphone access and select the intended input
device. If text does not appear, verify Accessibility access and try a standard
...
Quit Mach, remove the Mach app from your Applications folder, and remove any Mach
entries you no longer want under **System Settings → Privacy & Security**. For
account deletion or data requests, follow the instructions in the
